...
'user_id' => User::factory(),'status' => fake()->randomElement(['Processing','Canceled','Completed','pending']),'total_amount' => fake()->randomFloat(2,50,2000),'shipping_address' => fake()->address(),'payment_status' => fake()->randomElement(['pending','paid','failed','refunded']),];}}
